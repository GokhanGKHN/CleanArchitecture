...
public sealed class CreateCarCommandValidator : AbstractValidator<CreateCarCommand>
{
    public CreateCarCommandValidator()
    {
        ...
        RuleFor(p => p.Name).MinimumLength(3).WithMessage("Araç adı en az üç karakter olmaslı.");
        ...
        RuleFor(p => p.Model).MinimumLength(3).WithMessage("Araç modeli en az üç karakter olmaslı.");
        ...
        RuleFor(p => p.EnginePower).GreaterThan(0).WithMessage("Araç motor gücü 0 dan lüçük olamaz.");
    }
}
